...
columns_needed = ['period_begin', 'period_end', 'region_type', 'region', 'state', 'city', 'state_code', 'property_type', 'parent_metro_region', 'last_updated', 'price_drops', 'median_sale_price', 'median_dom', 'homes_sold', 'new_listings', 'inventory', 'months_of_supply']
